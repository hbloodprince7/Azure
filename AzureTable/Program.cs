...
var serviceClient = new TableServiceClient(
    new Uri("https://manvith.table.core.windows.net"),
    new TableSharedKeyCredential("manvith", "aOvwTMdqAk3AOwxMjoV88foH1Q0iKftkOliTCE7djokGvCNMqvlFmwq1lGHYQiFnX9DEpm2cDKUB+AStoENTFQ=="));
